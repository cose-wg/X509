...
documents](https://datatracker.ietf.org/wg/cose/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/cose/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/cose)). This will ensure that
